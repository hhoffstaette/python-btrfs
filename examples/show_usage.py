...
if not mixed_groups:
    ...
    print("Target profile for Data+Metadata: {}".format(usage.target_profile_data_metadata_str))
print()
...
if not mixed_groups:
    print("Estimated virtual space left to use for metadata: {}".format(usage.free_metadata_str))
    print("Estimated virtual space left to use for data: {}".format(usage.free_data_str))
else:
    print("Estimated virtual space left to use for metadata and data: {}".format(usage.free_str))
print()
